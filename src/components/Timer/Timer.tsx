...
const Timer = (props: Props) => {
    ...
    return (
        <div>
           {showTimer ?(
            <div className='flex items-center space-x-2 bg-graypu-1.5 cursor-pointer rounded hover:text-blue-500'>
            ...
            <div
					className='flex items-center p-1 h-8 hover:text-blue rounded cursor-pointer ' onClick={() => setShowTimer(true)}>
					<svg
